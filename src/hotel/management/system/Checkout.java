...
public class Checkout extends JFrame implements ActionListener{
	...
	lblid.setFont(new Font("serif",Font.ITALIC,20));
	...
	add(lblroomnumber);
        ...
        lblcheckin.setBackground(Color.WHITE);
	...
	add(lblcheckouttime);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/nine.jpeg"));
